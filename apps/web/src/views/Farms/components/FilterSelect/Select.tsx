...
import { ArrowDropDownIcon, Box, BoxProps, Text } from '@pancakeswap/uikit/src/components'
  ...
  return (
    <DropDownContainer isOpen={isOpen} {...props}>
      <DropDownHeader onClick={toggling}>
        <Text color={!optionSelected && placeHolderText ? '#ECF1FF' : '#ECF1FF'}>
          {!optionSelected && placeHolderText ? placeHolderText : options[selectedOptionIndex].label}
        </Text>
      </DropDownHeader>
      <ArrowDropDownIcon color="#ECF1FF" onClick={toggling} />
      <DropDownListContainer>
        <DropDownList>
